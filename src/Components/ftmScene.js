...
export default function Model(props) {
  ...
  const { nodes, materials } = useGLTF(
    process.env.PUBLIC_URL + '/models/ftm/scene.gltf'
  );
  return (
    <group ref={group} {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={1.25}>
        ...
        <group position={[7.25, 0.61, 6.92]} rotation={[-0.77, 0.65, 0.41]} />
        <group position={[-9.68, -8.07, 2.28]} rotation={[-0.77, 0.65, 0.41]} />
        <group position={[5.3, -9.82, 0.38]} rotation={[-0.77, 0.65, 0.41]} />
        ...
        <group position={[1.98, -3.33, 0]}>
          <mesh geometry={nodes.dec_0.geometry} material={materials.material} />
        </group>
        <group position={[1.98, -3.33, 0]}>
          <mesh
